/*
 * ChiefMikey's Reviung41 Keymap
 *
 * A custom keymap for the Reviung41 split keyboard featuring:
 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI |Alt/SPC|Adj/ENT|      /       \      |Adj/ENT|Low/SPC|
 *                   `----------------------'     '---------''---------------------------'
 */
...
[_LOWER] = LAYOUT_reviung41(
    ...
    KC_HOME, KC_AMPR, KC_HASH, KC_PERC, KC_EXLM, KC_PLUS,                    KC_CIRC, _______, _______, _______, KC_BSLS, KC_DEL,
                                    KC_ASTR, _______, _______,            _______, _______
),
